...
forecast_results <- eventReactive(
  ...
  valueExpr = {
    ...
    if (input$use_feat_set) {
        ...
        generate_forecast(
          data = data_transformed(), method = input$method, n_future = input$horizon,
...
tune_results <- eventReactive(
  ...
  valueExpr = {
    ...
    purrr::map(
      ...
      generate_forecast(
        data = data_transformed(), method = input$tune_method, n_future = input$horizon,
        n_assess = input$tune_n_assess, assess_type = input$tune_assess_type
      )
  }
)
  	...
  	if (input$comp_tune) {
  		...
  		react_val$comp_fit |> 
  			generate_forecast(
  				...
  				n_future = input$horizon,	n_assess = input$comp_n_assess,
  	...
  	if (input$ens_tune) {
  		...
  		react_val$combine_results <- react_val$ens_fit |> 
  			generate_forecast(
  				...
  				n_future = input$horizon,	n_assess = input$ens_n_assess,
  	...
  	if (input$scn_method == "Ensemble") {
  		...
  		if (input$scn_tune) {
  			...
  			react_val$ens_fit |>
  				generate_forecast(
  					data = data_transformed(), method = input$ens_method,
  					n_future = input$horizon, n_assess = input$scn_n_assess,
