...
react_val <- reactiveValues(tune_fit = purrr::set_names(vector("list", length(tune_methods)), tune_methods))
  	...
  	if (input$scn_tune) {
  		list(react_val$tune_fit[[input$scn_method]]) |> 
  			generate_forecast(
  				...
  				method = input$scn_method,
  				n_future = input$scn_n_future,
  				n_assess = input$scn_n_assess,
  				assess_type = input$scn_assess_type,
